#!/usr/bin/env python3
"""Temporary script to create the smart alert system file"""
...
with open('src/notification/alert_system.py', 'w', encoding='utf-8') as f:
    f.write(content)

print("Smart Alert System file created successfully!") 