...
### 5.1. Fundamental Screener (Scheduled)

| Command                                             | Description                                                                 | Example Usage                              |
|-----------------------------------------------------|-----------------------------------------------------------------------------|--------------------------------------------|
| `/schedules screener LIST_TYPE TIME [flags]`        | Schedule a fundamental screener report for undervalued stocks.              | `/schedules screener us_small_cap 09:00`   |
|                                                     |                                                                             | `/schedules screener us_large_cap 15:30 -email` |
|                                                     |                                                                             | `/schedules screener swiss_shares 10:00 -indicators=PE,PB,ROE` |
...
- `-indicators=...`: Comma-separated fundamental indicators (e.g., PE,PB,ROE,ROA,DY)
...
**Note:**  
- **All commands are case-insensitive** (e.g., `/REPORT`, `/Report`, `/report` all work the same)
- **Ticker symbols are automatically converted to uppercase** (e.g., `aapl` → `AAPL`, `btcusdt` → `BTCUSDT`)
- **Command actions are automatically converted to lowercase** (e.g., `SCREENER` → `screener`, `ADD` → `add`)
