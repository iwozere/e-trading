...
class CNNXGBoostStrategy(BaseStrategy):
    ...
    def _load_models(self):
        ...
        try:
            ...
            _logger.error("Error loading models: %s", e)
            raise
    ...
    def _load_cnn_model(self, model_path: str):
        ...
        try:
            ...
            _logger.error("Error loading CNN model: %s", e)
            raise
    ...
    def _load_xgb_models(self, models_dir: str):
        ...
        try:
            ...
            _logger.error("Error loading XGBoost models: %s", e)
            raise
    ...
    def _init_indicators(self):
        ...
        try:
            ...
            _logger.error("Error initializing indicators: %s", e)
            raise
    ...
    def _prepare_ohlcv_data(self) -> np.ndarray:
        ...
        try:
            ...
            _logger.error("Error preparing OHLCV data: %s", e)
            return None
    ...
    def _extract_cnn_features(self, ohlcv_data: np.ndarray) -> np.ndarray:
        ...
        try:
            ...
            _logger.error("Error extracting CNN features: %s", e)
            return None
    ...
    def _prepare_xgb_features(self) -> np.ndarray:
        ...
        try:
            ...
            _logger.error("Error preparing XGB features: %s", e)
            return None
    ...
    def _get_predictions(self) -> Dict[str, float]:
        ...
        try:
            ...
            _logger.error("Error getting predictions: %s", e)
            return {}
    ...
    def _calculate_signal_strength(self, predictions: Dict[str, float]) -> float:
        ...
        try:
            ...
            _logger.error("Error calculating signal strength: %s", e)
            return 0.0
