...
from src.shared.indicators.adapters import BBANDS, RSI
...
class SignalFactory:
    ...
    def get_signals(
        ...
        return {"entries": entries, "exits": exits, "short_entries": short_entries, "short_exits": short_exits}


# We want to wrap the logic into a vectorbt Indicator so we can use vbt.Param for optimization
def run_strategy_logic(close, rsi_window=14, rsi_lower=30, rsi_upper=70, bb_window=20, bb_std=2.0):
