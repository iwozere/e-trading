...
class StudyManager:
    ...
    def run_optimization(
        ...
        study = optuna.create_study(
            study_name=study_name, storage=self.storage_url, direction="maximize", load_if_exists=True
        )
        ...
        self.generate_report(
            study.best_trial, data, report_dir, strategy_config, benchmark_close, strategy_name=strategy_name
        )
