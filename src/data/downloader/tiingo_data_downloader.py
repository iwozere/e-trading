...
class TiingoDataDownloader:
    ...
    def get_ohlcv(self, symbol: str, interval: str, start_date: datetime,
        ...
        try:
            ...
            if not tiingo_interval:
                _logger.error(f"Unsupported interval: {interval}. Tiingo supports: 1d, 1w, 1m")
                return None
    ...
    def get_company_metadata(self, symbol: str) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            _logger.info(f"Retrieved metadata for {symbol}")
            return data

        except Exception as e:
            _logger.error(f"Error getting metadata for {symbol}: {e}")
            return None
    ...
    def get_income_statement(self, symbol: str, start_date: Optional[datetime] = None,
        ...
        try:
            ...
            _logger.info(f"Retrieved income statement for {symbol}")
            return data
    ...
    def get_balance_sheet(self, symbol: str, start_date: Optional[datetime] = None,
        ...
        try:
            ...
            _logger.info(f"Retrieved balance sheet for {symbol}")
            return data
    ...
    def get_cash_flow(self, symbol: str, start_date: Optional[datetime] = None,
        ...
        try:
            ...
            _logger.info(f"Retrieved cash flow for {symbol}")
            return data
    ...
    def get_financial_ratios(self, symbol: str, start_date: Optional[datetime] = None,
        ...
        try:
            ...
            _logger.info(f"Retrieved financial ratios for {symbol}")
            return data
        ...
        for symbol in symbols:
            try:
                ...
                if fundamentals:
                    ...
                    _logger.warning(f"No fundamental data available for {symbol}")

            except Exception as e:
                _logger.error(f"Error getting fundamentals for {symbol}: {e}")
                continue

        _logger.info(f"Retrieved fundamentals for {len(results)} out of {len(symbols)} symbols")
        return results
    ...
    def get_available_symbols(self) -> List[str]:
        ...
        try:
            ...
            if isinstance(data, list):
                ...
                _logger.info(f"Retrieved {len(symbols)} available symbols")
                return symbols
            else:
                return []

        except Exception as e:
            _logger.error(f"Error getting available symbols: {e}")
            return []
    ...
    def test_connection(self) -> bool:
        ...
        try:
            ...
            _logger.error(f"Tiingo API connection test failed: {e}")
            return False
