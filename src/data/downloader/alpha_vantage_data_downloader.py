...
class AlphaVantageDataDownloader(BaseDataDownloader):
    ...
    **Coverage:** Global stocks and ETFs
    ...
    def __init__(self, api_key: str | None = None):
        ...
        if not self.api_key:
            raise ValueError(
                "Alpha Vantage API key is required. Get one at: https://www.alphavantage.co/support/#api-key"
            )
    ...
    def get_fundamentals(self, symbol: str) -> OptionalFundamentals:
        ...
        try:
            ...
            overview_params = {"function": "OVERVIEW", "symbol": symbol, "apikey": self.api_key}
            ...
            quote_params = {"function": "GLOBAL_QUOTE", "symbol": symbol, "apikey": self.api_key}
    ...
    async def get_news_sentiment(
        self, symbol: str, time_from: str | None = None, limit: int = 50
    ) -> SentimentData | None:
        """
                ...
                async with session.get(url, params=params, timeout=aiohttp.ClientTimeout(total=60)) as response:
                    ...
                    for article in feed:
                        ...
                        if ticker_sent:
                            ...
                            ticker_sentiments.append({"score": sent_score, "label": sent_label, "relevance": relevance})
                    ...
                    _logger.debug(
                        "Retrieved news sentiment for %s: score=%.3f, articles=%d (bullish=%d, bearish=%d, neutral=%d)",
                        symbol,
                        overall_sentiment,
                        total_articles,
                        bullish_count,
    ...
    async def get_news_articles(
        self, symbol: str, time_from: str | None = None, limit: int = 200
    ) -> List[Dict[str, Any]]:
        """
