...
class TestDataManagerIntegration:
    ...
    def test_provider_selection_crypto(self, data_manager):
        ...
        # Test crypto symbol
        provider = data_manager.provider_selector.get_best_provider("BTCUSDT", "1h")
    ...
    def test_provider_selection_stock(self, data_manager):
        ...
        # Test stock symbol
        provider = data_manager.provider_selector.get_best_provider("AAPL", "1d")
        assert provider is not None
        assert hasattr(provider, 'get_ohlcv')
    ...
    def test_provider_failover(self, data_manager):
        ...
        with patch.object(data_manager.provider_selector, 'get_provider_with_failover') as mock_failover:
            mock_failover.return_value = [primary_downloader, fallback_downloader]
    ...
    def test_error_handling(self, data_manager):
        ...
        with patch.object(data_manager.provider_selector, 'get_provider_with_failover') as mock_failover:
            mock_failover.return_value = [failing_downloader]
