...
from config.donotshare.donotshare import ALPHA_VANTAGE_API_KEY, FINNHUB_API_KEY, POLYGON_API_KEY, TWELVE_DATA_API_KEY
...
@pytest.mark.parametrize(
    "downloader_class,period,interval",
    [
...
@pytest.mark.parametrize(
    "downloader_class,symbol,interval,api_env",
    [
