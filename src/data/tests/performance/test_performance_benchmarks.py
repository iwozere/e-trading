...
class PerformanceBenchmarks(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.cache = configure_unified_cache(cache_dir=self.cache_dir, max_size_gb=10.0)
    ...
    def _profile_function(self, func, *args, **kwargs):
        ...
        return {"result": result, "execution_time": end_time - start_time, "stats": None}
    ...
    def test_cache_write_performance(self):
        ...
        for size in sizes:
            ...
            profile_result = self._profile_function(
                self.cache.put, df, "TEST", "1h", start_date=df.index[0], end_date=df.index[-1], provider="benchmark"
            )
    ...
    def test_cache_read_performance(self):
        ...
        profile_result = self._profile_function(self.cache.get, "TEST", "1h", start_date, end_date)
    ...
    def test_data_optimization_performance(self):
        ...
        profile_result = self._profile_function(optimize_dataframe_performance, self.large_df)
        ...
        profile_result = self._profile_function(compress_dataframe_efficiently, optimized_df)
    ...
    def test_parallel_processing_performance(self):
        ...
        for workers in worker_counts:
            processor = ParallelProcessor(
                max_workers=workers, use_processes=False
            )  # Use threads to avoid pickle issues

            # Profile parallel processing
            profile_result = self._profile_function(processor.process_dataframe, self.large_df, process_chunk)
    ...
    def test_cache_cleanup_performance(self):
        ...
        profile_result = self._profile_function(self.cache.cleanup_old_data)
