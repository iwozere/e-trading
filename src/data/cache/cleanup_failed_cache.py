...
def main():
    ...
    parser.add_argument("--validate-only", action="store_true", help="Only validate cache files, don't remove anything")
    parser.add_argument("--cleanup", action="store_true", help="Remove invalid files from cache")
    parser.add_argument("--validate-and-cleanup", action="store_true", help="Validate and then cleanup invalid files")
