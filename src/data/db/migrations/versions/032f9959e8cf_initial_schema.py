...
Revision ID: 032f9959e8cf
Revises:
Create Date: 2025-11-24 20:31:47.651172
...
def upgrade() -> None:
    ...
    op.alter_column(
        "job_schedule_runs", "job_id", existing_type=sa.INTEGER(), type_=sa.BigInteger(), existing_nullable=True
    )
    op.alter_column(
        "job_schedule_runs",
        "enqueued_at",
    ...
    op.create_unique_constraint(
        "ux_runs_job_scheduled_for", "job_schedule_runs", ["job_type", "job_id", "scheduled_for"]
    )
    ...
    op.alter_column(
        "job_schedules", "enabled", existing_type=sa.BOOLEAN(), server_default=None, existing_nullable=False
    )
    op.alter_column(
        "job_schedules",
        "created_at",
    ...
    op.alter_column(
        "msg_channel_configs", "enabled", existing_type=sa.BOOLEAN(), server_default=None, existing_nullable=False
    )
    op.alter_column(
        "msg_channel_configs",
    ...
    op.alter_column(
        "msg_channel_configs", "max_retries", existing_type=sa.INTEGER(), server_default=None, existing_nullable=False
    )
    op.alter_column(
        "msg_channel_configs",
        "timeout_seconds",
    ...
    op.drop_table_comment(
        "msg_channel_configs", existing_comment="Channel plugin configuration and settings", schema=None
    )
    op.alter_column(
        "msg_delivery_status",
        "created_at",
    ...
    op.drop_table_comment(
        "msg_delivery_status", existing_comment="Per-channel delivery status tracking for each message", schema=None
    )
    op.alter_column(
        "msg_messages", "priority", existing_type=sa.VARCHAR(length=20), server_default=None, existing_nullable=False
    )
    op.alter_column(
        "msg_messages",
        "channels",
    ...
    op.alter_column(
        "msg_messages", "status", existing_type=sa.VARCHAR(length=20), server_default=None, existing_nullable=False
    )
    op.alter_column(
        "msg_messages", "retry_count", existing_type=sa.INTEGER(), server_default=None, existing_nullable=False
    )
    op.alter_column(
        "msg_messages", "max_retries", existing_type=sa.INTEGER(), server_default=None, existing_nullable=False
    )
    ...
    op.drop_index(
        op.f("idx_msg_messages_pending_poll"),
        table_name="msg_messages",
        postgresql_where="((status)::text = 'PENDING'::text)",
    )
    op.drop_index(
        op.f("idx_msg_messages_pending_priority"),
        table_name="msg_messages",
        postgresql_where="((status)::text = 'PENDING'::text)",
    )
    ...
    op.drop_index(
        op.f("idx_msg_messages_retry_eligible"),
        table_name="msg_messages",
    ...
    op.drop_table_comment(
        "msg_messages", existing_comment="Notification messages queue with priority and retry support", schema=None
    )
    op.alter_column(
        "msg_rate_limits",
        "last_refill",
    ...
    op.drop_table_comment(
        "msg_rate_limits", existing_comment="Per-user rate limiting configuration and state", schema=None
    )
    op.alter_column(
        "msg_system_health",
        "component",
    ...
    op.alter_column(
        "msg_system_health", "failure_count", existing_type=sa.INTEGER(), server_default=None, existing_nullable=False
    )
    op.alter_column(
        "msg_system_health",
        "checked_at",
    ...
    op.drop_table_comment(
        "msg_system_health", existing_comment="Health monitoring for notification channels", schema=None
    )
    op.alter_column(
    ...
    op.alter_column(
        "ss_ad_hoc_candidates", "active", existing_type=sa.BOOLEAN(), server_default=None, existing_nullable=False
    )
    op.alter_column(
        "ss_ad_hoc_candidates",
    ...
    op.alter_column("ss_alerts", "sent", existing_type=sa.BOOLEAN(), server_default=None, existing_nullable=False)
    op.drop_index(op.f("idx_ss_alerts_alert_level_timestamp"), table_name="ss_alerts")
    op.create_index(
        "idx_ss_alerts_alert_level_timestamp",
        "ss_alerts",
    ...
    op.create_index(
        "idx_ss_alerts_sent_timestamp", "ss_alerts", ["sent", "timestamp"], unique=False, postgresql_using="btree"
    )
    ...
    op.create_index(
        "idx_ss_deep_metrics_alert_level",
        "ss_deep_metrics",
        ["alert_level", "date"],
        unique=False,
        postgresql_using="btree",
    ...
    op.create_index(
        "idx_ss_deep_metrics_date_desc", "ss_deep_metrics", ["date"], unique=False, postgresql_using="btree"
    )
    op.drop_index(op.f("idx_ss_deep_metrics_squeeze_score_desc"), table_name="ss_deep_metrics")
    op.create_index(
        "idx_ss_deep_metrics_squeeze_score_desc",
        "ss_deep_metrics",
        ["squeeze_score", "date"],
        unique=False,
        postgresql_using="btree",
    ...
    op.create_index(
        "idx_ss_snapshot_run_date_desc", "ss_snapshot", ["run_date"], unique=False, postgresql_using="btree"
    )
    op.drop_index(op.f("idx_ss_snapshot_screener_score_desc"), table_name="ss_snapshot")
    op.create_index(
        "idx_ss_snapshot_screener_score_desc",
        "ss_snapshot",
        ["screener_score", "run_date"],
        unique=False,
        postgresql_using="btree",
    )
    ...
    op.drop_table_comment(
        "trading_performance_metrics", existing_comment="Performance metrics for trading strategies", schema=None
    )
    op.alter_column(
        "trading_positions",
        "id",
    ...
    op.drop_table_comment("trading_positions", existing_comment="Open and closed trading positions", schema=None)
    op.alter_column(
        "trading_trades",
        "id",
        existing_type=sa.INTEGER(),
    ...
    op.drop_table_comment("trading_trades", existing_comment="Individual trade records", schema=None)
    op.alter_column(
        "usr_auth_identities",
        "id",
        existing_type=sa.INTEGER(),
    ...
    op.create_index(
        "ix_auth_identities_provider_external", "usr_auth_identities", ["provider", "external_id"], unique=False
    )
    op.create_unique_constraint(
        "uq_auth_identities_provider_external", "usr_auth_identities", ["provider", "external_id"]
    )
    op.alter_column(
        "usr_users", "id", existing_type=sa.INTEGER(), server_default=None, existing_nullable=False, autoincrement=True
    )
    op.alter_column("usr_users", "is_active", existing_type=sa.BOOLEAN(), server_default=None, nullable=False)
    op.alter_column(
        "usr_users",
        "updated_at",
    ...
    op.drop_table_comment("usr_users", existing_comment="User accounts and authentication", schema=None)
    op.alter_column(
    ...
    op.alter_column(
        "webui_strategy_templates", "description", existing_type=sa.TEXT(), type_=sa.String(), existing_nullable=True
    )
    op.alter_column(
        "webui_strategy_templates",
        "updated_at",
    ...
    op.alter_column(
        "webui_system_config", "description", existing_type=sa.TEXT(), type_=sa.String(), existing_nullable=True
    )
    op.alter_column(
        "webui_system_config",
        "updated_at",
...
def downgrade() -> None:
    ...
    op.alter_column(
        "webui_system_config", "description", existing_type=sa.String(), type_=sa.TEXT(), existing_nullable=True
    )
    op.alter_column(
        "webui_system_config",
        "id",
        ...
        server_default=sa.Identity(
            always=True, start=1, increment=1, minvalue=1, maxvalue=2147483647, cycle=False, cache=1
        ),
        existing_nullable=False,
        autoincrement=True,
    )
    ...
    op.alter_column(
        "webui_strategy_templates", "description", existing_type=sa.String(), type_=sa.TEXT(), existing_nullable=True
    )
    op.alter_column(
        "webui_strategy_templates",
        "id",
    ...
    op.create_table_comment("usr_users", "User accounts and authentication", existing_comment=None, schema=None)
    ...
    op.alter_column("usr_users", "is_active", existing_type=sa.BOOLEAN(), server_default=sa.text("true"), nullable=True)
    op.alter_column(
        "usr_users",
        "id",
        existing_type=sa.INTEGER(),
    ...
    op.create_table_comment("trading_trades", "Individual trade records", existing_comment=None, schema=None)
    ...
    op.create_table_comment(
        "trading_positions", "Open and closed trading positions", existing_comment=None, schema=None
    )
    ...
    op.create_table_comment(
        "trading_performance_metrics", "Performance metrics for trading strategies", existing_comment=None, schema=None
    )
    ...
    op.create_unique_constraint(
        op.f("ss_deep_metrics_ticker_date_key"),
        "ss_deep_metrics",
        ["ticker", "date"],
    ...
    op.alter_column(
        "ss_alerts", "sent", existing_type=sa.BOOLEAN(), server_default=sa.text("false"), existing_nullable=False
    )
    op.alter_column(
        "ss_alerts",
        "timestamp",
    ...
    op.create_unique_constraint(
        op.f("ss_ad_hoc_candidates_ticker_key"), "ss_ad_hoc_candidates", ["ticker"], postgresql_nulls_not_distinct=False
    )
    op.alter_column(
        "ss_ad_hoc_candidates",
        "promoted_by_screener",
    ...
    op.create_table_comment(
        "msg_system_health", "Health monitoring for notification channels", existing_comment=None, schema=None
    )
    ...
    op.create_unique_constraint(
        op.f("msg_channel_health_channel_key"), "msg_system_health", ["component"], postgresql_nulls_not_distinct=False
    )
    op.create_index(
    ...
    op.create_table_comment(
        "msg_rate_limits", "Per-user rate limiting configuration and state", existing_comment=None, schema=None
    )
    ...
    op.create_index(
        op.f("idx_msg_messages_retry_eligible"),
        "msg_messages",
        ["status", "retry_count", "max_retries", "processed_at"],
        unique=False,
        postgresql_where="((status)::text = 'FAILED'::text)",
    )
    ...
    op.alter_column(
        "msg_messages", "max_retries", existing_type=sa.INTEGER(), server_default=sa.text("3"), existing_nullable=False
    )
    op.alter_column(
        "msg_messages", "retry_count", existing_type=sa.INTEGER(), server_default=sa.text("0"), existing_nullable=False
    )
    op.alter_column(
        "msg_messages",
        "status",
    ...
    op.create_index(
        op.f("idx_delivery_status_composite"), "msg_delivery_status", ["message_id", "channel", "status"], unique=False
    )
    ...
    op.create_table_comment(
        "msg_channel_configs", "Channel plugin configuration and settings", existing_comment=None, schema=None
    )
    ...
    op.create_unique_constraint(
        op.f("msg_channel_configs_channel_key"), "msg_channel_configs", ["channel"], postgresql_nulls_not_distinct=False
    )
    ...
    op.alter_column(
        "job_schedules", "enabled", existing_type=sa.BOOLEAN(), server_default=sa.text("true"), existing_nullable=False
    )
    op.alter_column(
        "job_schedules",
        "task_params",
    ...
    op.create_foreign_key(
        op.f("job_schedule_runs_job_id_fkey"),
        "job_schedule_runs",
        "job_schedules",
        ["job_id"],
        ["id"],
    ...
    op.create_index(
        op.f("ux_runs_job_scheduled_for"), "job_schedule_runs", ["job_type", "job_id", "scheduled_for"], unique=True
    )
    op.alter_column(
        "job_schedule_runs",
        "enqueued_at",
    ...
    op.alter_column(
        "job_schedule_runs", "job_id", existing_type=sa.BigInteger(), type_=sa.INTEGER(), existing_nullable=True
    )
    op.alter_column(
        "job_schedule_runs",
        "id",
