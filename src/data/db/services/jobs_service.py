...
class JobsService:
    ...
    def create_schedule(self, user_id: int, schedule_data: ScheduleCreate) -> Schedule:
        ...
        try:
            ...
            _logger.info(f"Created schedule: {schedule.name} for user {user_id}")
            return schedule
    ...
    def update_schedule(self, schedule_id: int, update_data: ScheduleUpdate) -> Optional[Schedule]:
        ...
        try:
            ...
            if schedule:
                self.session.commit()
                _logger.info(f"Updated schedule: {schedule.name} (ID: {schedule_id})")
    ...
    def delete_schedule(self, schedule_id: int) -> bool:
        ...
        try:
            ...
            if success:
                self.session.commit()
                _logger.info(f"Deleted schedule ID: {schedule_id}")
            return success
