...
class SystemHealthService:
    ...
    def update_system_health(
        ...
        try:
            ...
            _logger.error("Failed to update system health for %s.%s: %s", system, component, e)
            raise
    ...
    def get_system_health(self, system: str, component: Optional[str] = None) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            _logger.error("Failed to get system health for %s.%s: %s", system, component, e)
            raise
    ...
    def get_all_systems_health(self, include_stale: bool = True) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            _logger.error("Failed to get all systems health: %s", e)
            raise
    ...
    def get_systems_overview(self) -> Dict[str, Any]:
        ...
        try:
            ...
            _logger.error("Failed to get systems overview: %s", e)
            raise
    ...
    def get_notification_channels_health(self) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            _logger.error("Failed to get notification channels health: %s", e)
            raise
    ...
    def cleanup_stale_records(self, stale_threshold_hours: int = 24) -> int:
        ...
        try:
            ...
            _logger.error("Failed to cleanup stale records: %s", e)
            raise
