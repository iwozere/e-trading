...
class RedisCache:
    ...
    def _deserialize(self, data: bytes) -> Any:
        ...
        if self.compression_enabled and self.compressor:
            try:
                ...
                _logger.warning(f"Failed to decompress data: {e}")
                return None
        ...
        try:
            ...
            _logger.error(f"Failed to deserialize data: {e}")
            return None
    ...
    def get_info(self) -> Dict[str, Any]:
        ...
        try:
            ...
            _logger.error(f"Failed to get Redis info: {e}")
            return {}
...
class AdvancedDataCache(DataCache):
    ...
    def __init__(
        ...
        if redis_config and REDIS_AVAILABLE:
            try:
                ...
                _logger.warning(f"Failed to initialize Redis cache: {e}")
    ...
    def get(
        ...
        try:
            ...
            _logger.error(f"File cache get failed: {e}")
            with self._lock:
                self.metrics.errors += 1
            return None
    ...
    def put(
        ...
        if self.redis_cache:
            try:
                ...
                _logger.warning(f"Redis put failed: {e}")
                success = False
        ...
        try:
            ...
            _logger.error(f"File cache put failed: {e}")
            success = False
    ...
    def cleanup(self) -> None:
        ...
        if self.redis_cache:
            try:
                ...
                _logger.warning(f"Failed to disconnect Redis pool: {e}")
