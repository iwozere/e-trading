...
class DataCache:
    ...
    def _load_metadata(self) -> Dict[str, Any]:
        ...
        return {"files": {}, "last_cleanup": 0, "total_size_bytes": 0}
    ...
    def clear(self, provider: str | None = None, symbol: str | None = None):
    ...
    def get_stats(self) -> Dict[str, Any]:
        ...
        return {
            ...
            if self.metadata["last_cleanup"] > 0
            else None,
        }
...
def configure_cache(cache_dir: Union[str, Path] = DATA_CACHE_DIR, max_size_gb: float = 10.0, **kwargs):
