...
class ScheduleManager:
    ...
    def handle_schedules(self, parsed: ParsedCommand) -> Dict[str, Any]:
        ...
        try:
            ...
            if action == "add" and len(params) >= 2:
                ...
                return self.handle_schedules_add(
                    telegram_user_id, ticker, time, email, indicators, period, interval, provider
                )
                ...
                return self.handle_schedules_edit(
                    telegram_user_id, params[0], params[1] if len(params) > 1 else None, parsed.args
                )
    ...
    def handle_schedules_add(
        ...
        try:
            ...
            return {
                ...
                "message": f"Schedule #{schedule_id} created for {ticker.upper()} at {time} UTC.",
            }
        except Exception as e:
    ...
    def handle_schedules_add_json(self, telegram_user_id: str, config_json: str) -> Dict[str, Any]:
        ...
        try:
            ...
            schedule_id = self.telegram_service.add_json_schedule(
                telegram_user_id, config_json, schedule_config="report"
            )
    ...
    def handle_schedules_screener(
        ...
        try:
            ...
            return {
                ...
                "message": f"Fundamental screener scheduled (#{schedule_id}).",
            }
        except Exception:
    ...
    def handle_schedules_enhanced_screener(self, telegram_user_id: str, config_json: str) -> Dict[str, Any]:
        ...
        try:
            if not self.telegram_service:
                return {"status": "error", "message": "Service unavailable"}
            schedule_id = self.telegram_service.add_json_schedule(
                telegram_user_id, config_json, schedule_config="enhanced_screener"
            )
            return {
                "status": "ok",
                "title": "Enhanced Screener Scheduled",
                "message": f"Enhanced screener scheduled (#{schedule_id}).",
            }
        except Exception:
