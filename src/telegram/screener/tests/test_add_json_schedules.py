...
def test_add_json_schedules():
    ...
    result2 = parse_command(
        '/schedules add_json {"type":"report","tickers":["AAPL","MSFT","GOOGL"],"scheduled_time":"09:00","period":"1y","interval":"1d","indicators":"RSI,MACD","email":true}'
    )
    ...
    result3 = parse_command(
        '/schedules add_json {"type":"enhanced_screener","screener_type":"hybrid","list_type":"us_medium_cap","fmp_criteria":{"marketCapMoreThan":2000000000,"peRatioLessThan":20},"max_results":10,"min_score":7.0}'
    )
