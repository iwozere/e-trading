...
class HeartbeatManager:
    ...
    def send_immediate_heartbeat(
        ...
        try:
            ...
            _logger.error("Failed to send immediate heartbeat for %s.%s: %s",
                         self.system, self.component or 'main', e)
    ...
    def _heartbeat_loop(self):
        ...
        while self._running:
            try:
                ...
                _logger.error("Error in heartbeat loop for %s.%s: %s",
                             self.system, self.component or 'main', e)
                ...
                try:
                    ...
                    _logger.error("Failed to update DOWN status: %s", update_error)
