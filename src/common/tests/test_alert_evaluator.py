...
from src.common.alerts.alert_evaluator import AlertConfig, AlertEvaluator
...
class TestAlertEvaluator:
    ...
    def test_load_alert_state_valid(self, alert_evaluator):
        ...
        state_json = json.dumps({"status": "ARMED", "sides": {"test_key": "above"}, "trigger_count": 5})
    ...
    def test_evaluate_comparison_gt(self, alert_evaluator, sample_market_data):
        ...
        result, sides, snapshot = alert_evaluator._evaluate_comparison("gt", node, sample_market_data, {}, {})
    ...
    def test_evaluate_comparison_crosses_above(self, alert_evaluator):
        ...
        result1, sides1, snapshot1 = alert_evaluator._evaluate_comparison("crosses_above", node, data, {}, {})
        ...
        result2, sides2, snapshot2 = alert_evaluator._evaluate_comparison("crosses_above", node, data, {}, sides_state)
    ...
    def test_evaluate_rule_tree_and_logic(self, alert_evaluator, sample_market_data):
        ...
        result, sides, snapshot = alert_evaluator._evaluate_rule_tree(rule, sample_market_data, {}, {})
    ...
    def test_evaluate_rule_tree_not_logic(self, alert_evaluator, sample_market_data):
        ...
        rule = {"not": {"gt": {"lhs": {"field": "close"}, "rhs": {"value": 200}}}}
    ...
    def test_apply_rearm_logic_armed_to_triggered(self, alert_evaluator):
        ...
        alert_config = AlertConfig(
            ticker="BTCUSDT", timeframe="1h", rule={}, rearm={"enabled": True}, options={}, notify={}
        )
        current_state = {"status": "ARMED"}
    ...
    def test_migrate_state_legacy(self, alert_evaluator):
        ...
        legacy_state = {"is_armed": True, "some_old_field": "value"}
