...
class HealthMonitor:
    ...
    async def check_system_health(self, system: str, component: Optional[str] = None) -> HealthCheckResult:
        ...
        try:
            ...
            _logger.error("Health check failed for system %s: %s", system, e)
            return HealthCheckResult(
                system=system,
                component=component,
    ...
    async def check_all_systems_health(self) -> List[HealthCheckResult]:
        ...
        try:
            ...
            _logger.error("Failed to check all systems health: %s", e)
    ...
    async def update_health_status(self, result: HealthCheckResult):
        ...
        try:
            ...
            _logger.error("Failed to update health status for %s: %s", result.system, e)
    ...
    async def get_system_health_summary(self) -> Dict[str, Any]:
        ...
        try:
            ...
            _logger.error("Failed to get health summary: %s", e)
            return {
    ...
    async def start_monitoring(self, interval: int = 60):
        ...
        while self._running:
            try:
                ...
                _logger.error("Error during health monitoring cycle: %s", e)
