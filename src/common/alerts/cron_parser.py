...
class CronParser:
    ...
    def parse_cron(expression: str, timezone: Optional[str] = None) -> CronExpression:
        ...
        try:
            ...
            _logger.error("Failed to parse cron expression '%s': %s", expression, str(e))
    ...
    def calculate_next_run(expression: str, from_time: Optional[datetime] = None,
        ...
        try:
            ...
            _logger.error("Failed to calculate next run for '%s': %s", expression, str(e))
    ...
    def get_next_n_runs(expression: str, count: int, from_time: Optional[datetime] = None,
        ...
        try:
            ...
            _logger.error("Failed to generate runs for '%s': %s", expression, str(e))
