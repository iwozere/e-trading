...
Debug Mode:
  Set DEBUG_MODE = True and DEBUG_CONFIG at the top of the file, then run from IDE
    ...
    parser.add_argument("--list-configs", action="store_true", help="List all available configuration files")
    ...
    return run_backtest(config_path=args.config, generate_report=not args.no_report, verbose=args.verbose)
