...
def main():
    ...
    parser.add_argument(
        "--tf", type=str, help="Specific timeframe to analyze (e.g., 1h, 15m). If omitted, runs all detected."
    )
    ...
    _logger.info("Thresholds: Entry=%.1f, Exit=%.1f", config.zscore_entry_threshold, config.zscore_exit_threshold)
