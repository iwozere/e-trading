...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--user-id", type=str, default=None, help="User ID injected by the scheduler.")
    parser.add_argument(
        "--as-of-date", type=str, default=None, help="ISO date to run for (e.g. 2026-06-14). Defaults to today."
    )
    parser.add_argument("--force-refresh", action="store_true", help="Force re-download of all cached data.")
