...
from src.ml.pipeline.p04_short_squeeze.config.config_manager import ConfigManager, ConfigValidationError
from src.ml.pipeline.p04_short_squeeze.config.data_classes import PipelineConfig, SchedulingConfig, ScreenerConfig
...
class TestConfigManager(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.valid_config = {
            ...
            "deep_scan": {
                ...
                "metrics": {"volume_lookback_days": 14, "sentiment_lookback_hours": 24, "options_min_volume": 100},
                "scoring": {
                    "weights": {"volume_spike": 0.35, "sentiment_24h": 0.25, "call_put_ratio": 0.20, "borrow_fee": 0.20}
                },
            },
            "alerting": {
                "thresholds": {
    ...
    def test_substitute_env_vars_simple(self):
        ...
        test_config = {"test_value": "${TEST_VAR}", "nested": {"another_value": "${ANOTHER_VAR}"}}
    ...
    def test_substitute_env_vars_with_default(self):
        ...
        test_config = {"with_default": "${MISSING_VAR:default_value}", "without_default": "${EXISTING_VAR}"}
