...
class TestTransientMetricsEnhanced:
    ...
    def test_transient_metrics_default_sentiment_fields(self):
        ...
        metrics = TransientMetrics(volume_spike=2.0, call_put_ratio=None, sentiment_24h=0.0, borrow_fee_pct=None)
...
class TestScoringEngineEnhanced:
    ...
    def scoring_config(self):
        ...
        return ScoringConfig(normalization_method="minmax", score_bounds=(0.0, 1.0), weight_validation=True)

    @pytest.fixture
    def deep_scan_weights(self):
        """Create test deep scan weights."""
        return DeepScanWeights(volume_spike=0.35, sentiment_24h=0.25, call_put_ratio=0.20, borrow_fee=0.20)
    ...
    def test_calculate_virality_score_no_bots(self, scoring_engine):
        ...
        score = scoring_engine.calculate_virality_score_with_bot_penalty(virality_index=0.8, bot_pct=0.0)
