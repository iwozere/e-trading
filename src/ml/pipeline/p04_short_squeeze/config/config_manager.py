...
class ConfigManager:
    ...
    def _build_performance_config(self, config: Dict[str, Any]) -> PerformanceConfig:
        ...
        return PerformanceConfig(api_rate_limits=api_limits, database=database, error_handling=error_handling)
    ...
    def _validate_config(self, config: PipelineConfig) -> None:
        ...
        screener_total = (
            screener_weights.short_interest_pct
        ...
        deep_scan_total = (
            deep_scan_weights.volume_spike
