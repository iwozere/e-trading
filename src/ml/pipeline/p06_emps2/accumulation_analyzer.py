...
class AccumulationAnalyzer:
    ...
    def __init__(self, data_manager: DataManager, config: EMPS2FilterConfig, results_dir: Path,
        ...
        _logger.info(
            "AccumulationAnalyzer initialized: AR>%.1f, Vol Z-Score>%.1f, "
    ...
    def _check_accumulation(self, ticker: str, df_intra: pd.DataFrame, df_daily: pd.DataFrame) -> tuple:
        ...
        atr_14 = talib.ATR(df_daily['high'].values, df_daily['low'].values, df_daily['close'].values,
        ...
        price_range_1d = (
            ...
            if df_daily['low'].iloc[-1] > 0 else 0.0
        )
