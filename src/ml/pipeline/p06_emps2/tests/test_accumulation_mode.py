...
def test_build_analyzer_returns_volatility_filter_by_default():
    ...
    with patch("src.ml.pipeline.p06_emps2.emps2_pipeline.NasdaqUniverseDownloader"), \
...
def test_emps3_pipeline_emits_deprecation_warning():
    ...
    with patch("src.ml.pipeline.p10_emps3.emps3_pipeline.EMPS2Pipeline"), \
...
def test_emps3_pipeline_run_delegates_to_emps2():
    ...
    with patch("src.ml.pipeline.p10_emps3.emps3_pipeline.EMPS2Pipeline", return_value=mock_emps2), \
