        ...
        for i in range(len(price_series)):
            ...
            if exposure > 0 and current_stop_loss > 0:
                if current_price < current_stop_loss:
                    ...
                    logger.info(f"ATR Stop-loss triggered for {current_date} at {current_price:.2f} (SL: {current_stop_loss:.2f})")
            ...
            if i > 0:
                ...
                if target_exposure < exposure: # Exit or Reduce
                    ...
                    if exposure == 0:
                        ...
                        avg_entry_price = (exposure * avg_entry_price + added_exposure * current_price) / target_exposure
