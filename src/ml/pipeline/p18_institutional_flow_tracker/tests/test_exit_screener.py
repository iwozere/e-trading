        ...
        [
            {
                ...
                "exit_type": "full_exit",
                "delta_pct": -1.0,
                "pct_of_portfolio_prev": 0.02,
                "value_usd_prev": 50_000_000,
            }
        ]
    )
        ...
        [
            {
                ...
                "exit_type": "full_exit",
                "delta_pct": -1.0,
                "pct_of_portfolio_prev": 0.001,
                "value_usd_prev": 1_000_000,
            }
        ]
    )
    result = screener.screen(df)
        ...
        [
            {
                ...
                "delta_pct": -0.10,
                "pct_of_portfolio_prev": 0.05,
                "value_usd_prev": 100_000_000,
            }
        ]
    )
    result = screener.screen(df)
