...
def plot_regimes(df: pd.DataFrame, output_path: str):
    ...
    fig, (ax1, ax2) = plt.subplots(2, 1, figsize=(60, 10), sharex=True, gridspec_kw={"height_ratios": [3, 1]})
...
def main():
    ...
    """
    parser = argparse.ArgumentParser(description="Visualize HMM market regimes from a CSV file.")
    parser.add_argument("--csv", required=True, help='Path to the CSV file with a pre-calculated "regime" column.')
