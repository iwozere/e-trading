...
class TAFeatureEngineer:
    ...
    def __init__(self, config: Dict[str, Any]) -> None:
        ...
        self.indicators = self.ta_config.get("indicators", [
            "rsi_14", "macd", "macd_signal", "macd_histogram",
            "bb_upper", "bb_lower", "bb_position", "atr_14",
            "sma_20", "ema_12", "price_vs_sma20", "price_vs_ema12",
    ...
    def _calculate_technical_indicators(self, df: pd.DataFrame) -> pd.DataFrame:
        ...
        if "rsi_14" in self.indicators:
            ta_features["rsi_14"] = talib.RSI(close_prices, timeperiod=14)
        ...
        if "atr_14" in self.indicators:
            ta_features["atr_14"] = talib.ATR(high_prices, low_prices, close_prices, timeperiod=14)
        ...
        if "ema_12" in self.indicators:
            ta_features["ema_12"] = talib.EMA(close_prices, timeperiod=12)
            ta_features["price_vs_ema12"] = close_prices / ta_features["ema_12"]
