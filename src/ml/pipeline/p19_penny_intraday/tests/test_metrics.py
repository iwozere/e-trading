...
from src.ml.pipeline.p19_penny_intraday.metrics import session_fraction, compute_signal
...
def _utc(hh, mm):
    ...
    return datetime(2026, 6, 24, hh, mm, tzinfo=_ET).astimezone(timezone.utc)
...
def test_compute_signal_pct_and_rvol():
    e = WatchlistEntry(ticker="AAA", source="p17", tier="B",
                       avg_volume_30d=1_000_000, prior_close=2.0)
