...
class FeatureExtractor:
    ...
    def _load_trained_model(self) -> HybridCNNLSTM:
        ...
        _logger.info(f"Loading model from: {latest_model_file.name}")
    ...
    def extract_cnn_lstm_features(self, X: np.ndarray) -> np.ndarray:
        ...
        _logger.info(f"Extracted CNN-LSTM features shape: {cnn_lstm_features.shape}")
    ...
    def get_technical_indicators(self, X: np.ndarray) -> np.ndarray:
        ...
        _logger.info(f"Technical indicators shape: {technical_indicators.shape}")
    ...
    def combine_features(self, cnn_lstm_features: np.ndarray, technical_indicators: np.ndarray) -> np.ndarray:
        ...
        _logger.info(f"Combined features shape: {combined_features.shape}")
    ...
    def extract_all_features(self) -> Dict[str, np.ndarray]:
        ...
        for split_name in ['train', 'val', 'test']:
            _logger.info(f"Processing {split_name} split...")
            ...
            _logger.info(f"{split_name} features shape: {combined_features.shape}")
