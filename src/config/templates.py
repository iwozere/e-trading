...
from src.model.schemas import BrokerType, DataSourceType, Environment, NotificationType, StrategyType
...
class ConfigTemplates:
    ...
    def _get_paper_trading_template(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "broker": {"type": BrokerType.BINANCE_PAPER, "initial_balance": 10000.0, "commission": 0.001},
            "trading": {
                "symbol": "BTCUSDT",
                "position_size": 0.1,
                "max_positions": 1,
            ...
            "strategy": {
                ...
                "exit_logic": {"name": "RSIBBExitMixin", "params": {"rsi_period": 14, "rsi_overbought": 70}},
                "position_size": 0.1,
            },
            "risk_management": {
                "stop_loss_pct": 5.0,
        ...
        template.update(
            {
                ...
                "risk_management": {
                    ...
                    "trailing_stop": {"enabled": True, "activation_pct": 2.0, "trailing_pct": 1.5},
                },
                "logging": {
                    "level": "WARNING",
                    "save_trades": True,
        ...
        template.update(
            {
                ...
                "exit_strategies": [
                    ...
                    },
                    {
                        ...
                        "params": {"trail_pct": {"type": "float", "low": 0.01, "high": 0.1, "default": 0.02}},
                    },
                ],
            }
        )
    ...
    def _get_development_env_template(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "log_level": "DEBUG",
            "hot_reload": True,
            "database": {"url": "sqlite:///dev_trading.db", "echo": True},
            "api": {"host": "localhost", "port": 5000, "debug": True},
        }
    ...
    def _get_staging_env_template(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "log_level": "INFO",
            "hot_reload": False,
            "database": {"url": "sqlite:///staging_trading.db", "echo": False},
    ...
    def _get_production_env_template(self) -> Dict[str, Any]:
        ...
        return {
            ...
            "log_level": "WARNING",
            "hot_reload": False,
            "database": {"url": "sqlite:///prod_trading.db", "echo": False},
            "api": {"host": "0.0.0.0", "port": 5000, "debug": False},
            "security": {"require_ssl": True, "rate_limit": True, "max_requests_per_minute": 100},
        }
