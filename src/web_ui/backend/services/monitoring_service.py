...
class SystemMonitoringService:
    ...
    def get_cpu_metrics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            _logger.error("Failed to get CPU metrics: %s", e)
            return {
                'usage_percent': 0.0,
                'core_count': 0,
                'per_core_usage': [],
    ...
    def get_memory_metrics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            _logger.error("Failed to get memory metrics: %s", e)
            return {
                'total_gb': 0.0,
                'available_gb': 0.0,
                'used_gb': 0.0,
    ...
    def get_disk_metrics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            _logger.error("Failed to get disk metrics: %s", e)
            return {
                'partitions': {},
                'io_stats': {
                    'read_bytes': 0,
    ...
    def get_temperature_metrics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            _logger.error("Failed to get temperature metrics: %s", e)
            return {
                'sensors': {},
    ...
    def get_network_metrics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            _logger.error("Failed to get network metrics: %s", e)
            return {
                'bytes_sent': 0,
                'bytes_recv': 0,
                'packets_sent': 0,
    ...
    def get_process_metrics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            _logger.error("Failed to get process metrics: %s", e)
            return {
                'current_process': {},
                'related_processes': []
            }
    ...
    def _check_thresholds(self, metrics: Dict[str, Any]):
        ...
        try:
            ...
            _logger.error("Failed to check thresholds: %s", e)
    ...
    def acknowledge_alert(self, alert_index: int) -> bool:
        ...
        try:
            ...
            _logger.error("Failed to acknowledge alert: %s", e)
            return False
