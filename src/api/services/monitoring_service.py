...
class SystemAlert:
    ...
    def __init__(self, alert_type: str, severity: str, message: str, details: Dict[str, Any] | None = None):
...
class SystemMonitoringService:
    ...
    def get_host_metrics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            uptime_seconds = (datetime.now(UTC) - boot_dt).total_seconds()
            return {"boot_time": boot_dt.isoformat(), "uptime_seconds": round(uptime_seconds, 1)}
    ...
    def get_disk_metrics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"partitions": disk_usage, "io_stats": io_stats}
    ...
    def get_temperature_metrics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"sensors": temperatures, "average_celsius": avg_temp}

        except Exception:
            _logger.exception("Failed to get temperature metrics:")
            return {"sensors": {}, "average_celsius": None}
    ...
    def get_process_metrics(self) -> Dict[str, Any]:
        ...
        try:
            ...
            return {"current_process": {}, "related_processes": []}
    ...
    def _add_alert(self, alert_type: str, severity: str, message: str, details: Dict[str, Any] | None = None):
        """
        ...
        for existing_alert in self.alerts:
            if (
                ...
                and existing_alert.severity == severity
                and existing_alert.timestamp > cutoff_time
                and not existing_alert.acknowledged
            ):
