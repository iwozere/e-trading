...
class UnifiedAnalyticsService:
    ...
    def _get_notification_analytics(self):
        ...
        if self._notification_analytics is None:
            try:
                ...
                self._logger.error("Failed to initialize notification analytics: %s", e)
                raise
    ...
    async def get_notification_delivery_rates(
        ...
        try:
            ...
            self._logger.error("Failed to get notification delivery rates: %s", e)
            raise
    ...
    async def get_notification_response_times(
        ...
        try:
            ...
            self._logger.error("Failed to get notification response times: %s", e)
            raise
    ...
    async def get_notification_trends(
        ...
        try:
            ...
            self._logger.error("Failed to get notification trends: %s", e)
            raise
    ...
    async def get_notification_aggregated_stats(
        ...
        try:
            ...
            self._logger.error("Failed to get notification aggregated stats: %s", e)
            raise
    ...
    async def get_notification_channel_comparison(
        ...
        try:
            ...
            self._logger.error("Failed to get notification channel comparison: %s", e)
            raise
    ...
    async def get_unified_dashboard_data(
        ...
        try:
            ...
            try:
                ...
                self._logger.error("Failed to get notification data for dashboard: %s", e)
            ...
            self._logger.error("Failed to get unified dashboard data: %s", e)
            raise
    ...
    def _calculate_system_health_score(
        ...
        try:
            ...
            self._logger.error("Failed to calculate system health score: %s", e)
            return {
                "overall_score": 0.0,
