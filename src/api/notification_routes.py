...
async def get_delivery_rates_analytics(
    ...
    try:
        ...
        _logger.error("Error getting delivery rates analytics: %s", e)
...
async def get_response_time_analytics(
    ...
    try:
        ...
        _logger.error("Error getting response time analytics: %s", e)
...
async def get_trend_analytics(
    ...
    try:
        ...
        _logger.error("Error getting trend analytics: %s", e)
...
async def get_aggregated_analytics(
    ...
    try:
        ...
        _logger.error("Error getting aggregated analytics: %s", e)
...
async def get_channel_performance_comparison(
    ...
    try:
        ...
        _logger.error("Error getting channel performance comparison: %s", e)
