...
class IndicatorFactory:
    ...
    def create_bollinger_bands(self, name: str, period: int = 20, devfactor: float = 2.0) -> Dict[str, pd.Series]:
        ...
        bb_data = {"upper": upper_band, "middle": sma, "lower": lower_band}
    ...
    def create_macd(
        self, name: str, fast_period: int = 12, slow_period: int = 26, signal_period: int = 9
    ) -> Dict[str, pd.Series]:
    ...
    def create_stochastic(self, name: str, k_period: int = 14, d_period: int = 3) -> Dict[str, pd.Series]:
        ...
        stoch_data = {"k": k_percent, "d": d_percent}

        self.indicators[name] = stoch_data
        return stoch_data

    def get_indicator(self, name: str) -> Union[pd.Series, Dict[str, pd.Series]] | None:
    ...
    def create_backtrader_rsi(self, data, period: int = 14, backend: str = "bt"):
        ...
        return self._backtrader_factory.create_rsi(data, period=period, backend=backend)
    ...
    def create_backtrader_macd(
        self, data, fast_period: int = 12, slow_period: int = 26, signal_period: int = 9, backend: str = "bt"
    ):
        """Create Backtrader MACD indicator using unified service"""
        return self._backtrader_factory.create_macd(
            data, fast_period=fast_period, slow_period=slow_period, signal_period=signal_period, backend=backend
        )
