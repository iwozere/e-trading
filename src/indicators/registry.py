...
def _build_indicator_meta() -> Dict[str, IndicatorMeta]:
    ...
    from src.indicators.models import FUNDAMENTAL_INDICATORS, LEGACY_INDICATOR_NAMES, TECHNICAL_INDICATORS
...
def get_indicator_meta(indicator_name: str) -> IndicatorMeta | None:
