...
class TestAdapterIntegration:
    ...
    @pytest.mark.asyncio
    async def test_ta_lib_adapter_with_real_data(self, realistic_market_data, input_series):
        ...
        for indicator_name, params in indicators_to_test:
            if adapter.supports(indicator_name):
                result = await adapter.compute(indicator_name, realistic_market_data, input_series, params)
    ...
    @pytest.mark.asyncio
    async def test_pandas_ta_adapter_with_real_data(self, realistic_market_data, input_series):
    ...
    @pytest.mark.asyncio
    async def test_cross_adapter_consistency(self, realistic_market_data, input_series):
        ...
        for indicator_name, ta_params, pta_params in common_indicators:
            if ta_lib.supports(indicator_name) and pandas_ta.supports(indicator_name):
                ta_result = await ta_lib.compute(indicator_name, realistic_market_data, input_series, ta_params)
                pta_result = await pandas_ta.compute(indicator_name, realistic_market_data, input_series, pta_params)
    ...
    @pytest.mark.asyncio
    async def test_fundamentals_adapter_integration(self):
        ...
        for indicator in fundamental_indicators:
            if adapter.supports(indicator):
                result = await adapter.compute(indicator, pd.DataFrame(), {}, {"ticker": "AAPL", "provider": None})
    ...
    @pytest.mark.asyncio
    async def test_adapter_error_handling(self, realistic_market_data, input_series):
        ...
        try:
            result = await adapter.compute("rsi", small_data, small_inputs, {"timeperiod": 14})
        ...
        with pytest.raises(KeyError):
            await adapter.compute("atr", realistic_market_data, incomplete_inputs, {"timeperiod": 14})

    @pytest.mark.asyncio
    async def test_adapter_fallback_mechanisms(self, realistic_market_data, input_series):
    ...
    @pytest.mark.asyncio
    async def test_multi_output_indicator_integration(self, realistic_market_data, input_series):
    ...
    @pytest.mark.asyncio
    async def test_adapter_performance_characteristics(self, realistic_market_data, input_series):
        ...
        for size in data_sizes:
            ...
            result = await adapter.compute("rsi", test_data, test_inputs, {"timeperiod": 14})
    ...
    @pytest.mark.asyncio
    async def test_adapter_memory_efficiency(self, realistic_market_data, input_series):
        ...
        result = await adapter.compute("rsi", large_data, large_inputs, {"timeperiod": 14})
