...
@pytest.mark.skipif(
    talib is None and pandas_ta is None, reason="Neither TA-Lib nor pandas_ta available for real adapters"
)
...
@pytest.mark.skipif(
    ...
    reason="Set RUN_INTEGRATION_TESTS=1 to run integration test against real data providers",
)
