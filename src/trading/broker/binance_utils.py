...
class BinanceSymbolValidator:
    ...
    def is_symbol_valid(self, symbol: str) -> bool:
        ...
        return symbol in self.symbol_filters and self.symbol_filters[symbol]["status"] == "TRADING"
...
class BinanceWebSocketProcessor:
    ...
    @staticmethod
    def process_ticker_message(message: Dict[str, Any]) -> Dict[str, Any] | None:
        """
    ...
    @staticmethod
    def process_trade_message(message: Dict[str, Any]) -> Dict[str, Any] | None:
        """
    ...
    @staticmethod
    def process_depth_message(message: Dict[str, Any]) -> Dict[str, Any] | None:
        """
...
class BinanceOrderFormatter:
    ...
    def validate_and_format_order(self, symbol: str, quantity: float, price: float | None = None) -> Dict[str, Any]:
        """
        ...
        if price is not None:
            ...
            if not price_valid:
                ...
                notional_valid, notional_error = self.validator.validate_notional(symbol, adj_qty, adj_price)
