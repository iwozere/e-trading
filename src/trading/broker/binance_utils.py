...
class BinanceWebSocketProcessor:
    ...
    def process_ticker_message(message: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            _logger.warning(f"Error processing ticker message: {e}")
            return None
    ...
    def process_trade_message(message: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            _logger.warning(f"Error processing trade message: {e}")
            return None
    ...
    def process_depth_message(message: Dict[str, Any]) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            _logger.warning(f"Error processing depth message: {e}")
            return None
...
class BinanceOrderFormatter:
    ...
    def format_quantity(self, symbol: str, quantity: float) -> str:
        ...
        if not is_valid:
            _logger.warning(f"Quantity validation failed: {error}")
            return str(quantity)
    ...
    def format_price(self, symbol: str, price: float) -> str:
        ...
        if not is_valid:
            _logger.warning(f"Price validation failed: {error}")
            return str(price)
