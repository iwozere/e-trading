...
from src.trading.broker.ibkr_utils import IBKRCommissionCalculator, IBKRContractManager, create_ibkr_config_template
...
class TestIBKRBroker:
    ...
    def live_config(self):
        ...
        return {
            ...
            "trading_mode": "live",
            "cash": 50000.0,
            "connection": {"host": "127.0.0.1", "port": 4001, "client_id": 1},
            "live_trading_confirmed": True,
            "risk_management": {"max_position_size": 5000.0, "max_daily_loss": 2000.0},
            "notifications": {
                "position_opened": True,
                "position_closed": True,
                "email_enabled": False,  # Disable for tests
    ...
    async def test_paper_portfolio_tracking(self, paper_broker):
        ...
        buy_order = Order(symbol="AAPL", side=OrderSide.BUY, order_type=OrderType.MARKET, quantity=100)
    ...
    async def test_pending_order_processing(self, paper_broker):
        ...
        order = Order(symbol="AAPL", side=OrderSide.BUY, order_type=OrderType.LIMIT, quantity=100, price=149.0)
...
class TestIBKRIntegration:
    ...
    async def test_full_paper_trading_workflow(self):
        ...
        with patch("src.trading.broker.ibkr_broker.IB") as mock_ib_class:
            ...
            # Place sell order
            sell_order = Order(symbol="AAPL", side=OrderSide.SELL, order_type=OrderType.MARKET, quantity=100)
