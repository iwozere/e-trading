...
from src.trading.broker.broker_manager import BrokerConnectionPool, BrokerHealthMonitor, BrokerManager, BrokerStatus
from src.trading.broker.config_manager import ConfigManager, ConfigTemplate, Environment, EnvironmentManager
...
class TestBrokerFactory:
    ...
    def test_validate_broker_config_valid(self):
        ...
        config = {"type": "binance", "trading_mode": "paper", "cash": 10000.0}
    ...
    def test_validate_broker_config_invalid_type(self):
        ...
        config = {"type": "invalid_broker", "trading_mode": "paper"}
    ...
    def test_validate_broker_config_invalid_mode(self):
        ...
        config = {"type": "binance", "trading_mode": "invalid_mode"}
    ...
    def test_validate_broker_config_live_trading_requirements(self):
        ...
        config.update(
            {"live_trading_confirmed": True, "risk_management": {"max_position_size": 1000.0, "max_daily_loss": 500.0}}
        )
    ...
    def test_get_broker_ibkr(self, mock_ibkr):
        ...
        config = {"type": "ibkr", "trading_mode": "paper", "cash": 25000.0}
    ...
    def test_get_broker_mock(self, mock_mock_broker):
        ...
        config = {"type": "mock", "trading_mode": "paper", "cash": 5000.0}
...
class TestBrokerManager:
    ...
    def broker_manager(self):
        ...
        return BrokerManager({"health_check_interval": 5, "auto_restart_enabled": True})
    ...
    async def test_add_broker(self, broker_manager):
        ...
        config = {"type": "mock", "trading_mode": "paper", "cash": 10000.0}
...
class TestConfigManager:
    ...
    def test_template_manager(self):
        ...
        config = template_manager.create_from_template("binance_paper", {"cash": 20000.0})
    ...
    def test_environment_manager(self, temp_config_dir):
        ...
        env_config = {"notifications": {"email_enabled": True, "telegram_enabled": False}}
        ...
        # Apply overrides
        base_config = {"type": "binance", "notifications": {"email_enabled": False, "telegram_enabled": True}}
    ...
    def test_config_templates(self, config_manager):
        ...
        # Create from template
        result = config_manager.create_from_template("template_config", "conservative", {"cash": 5000.0})
        assert result is True
