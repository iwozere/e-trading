...
class MessagePoller:
    ...
    async def _polling_loop(self):
        ...
        while self.running:
            try:
                ...
                self._logger.error("Error in polling loop: %s", e)
                # Back off on error
    ...
    async def _poll_pending_messages(self):
        ...
        try:
            ...
            self._logger.error("Error polling pending messages: %s", e)
            return []
    ...
    async def _process_messages(self, messages):
        ...
        try:
            ...
            self._logger.error("Error processing messages: %s", e)
...
class HealthReporter:
    ...
    async def _reporting_loop(self):
        ...
        while self.running:
            try:
                ...
                self._logger.error("Error in health reporting loop: %s", e)
                await asyncio.sleep(self.report_interval_seconds)
    ...
    async def _report_service_health(self):
        ...
        try:
            ...
            self._logger.error("Error reporting service health: %s", e)
    ...
    async def _report_channel_health(self):
        ...
        try:
            ...
            self._logger.error("Error reporting channel health: %s", e)
