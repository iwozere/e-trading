...
class MessageQueue:
    ...
    def enqueue(
        ...
        try:
            ...
            self._logger.error("Failed to enqueue message: %s", e)
            raise
        ...
        try:
            ...
            with get_repository_context() as repo:
                ...
                for message in messages:
                    ...
                    repo.messages.update_message(message.id, {
            ...
            self._logger.error("Failed to dequeue messages: %s", e)
            raise
    ...
    def dequeue_high_priority(self, limit: int = 5) -> List[QueuedMessage]:
        ...
        try:
            ...
            with get_repository_context() as repo:
                ...
                critical_messages = repo.messages.get_pending_messages(
                    current_time=current_time,
                ...
                if remaining_limit > 0:
                    high_messages = repo.messages.get_pending_messages(
                        current_time=current_time,
            ...
            self._logger.error("Failed to dequeue high priority messages: %s", e)
            raise
        ...
        try:
            ...
            with get_repository_context() as repo:
                ...
                for message in messages:
                    ...
                    updated_message = repo.messages.get_message(message.id)
            ...
            self._logger.error("Failed to dequeue retry messages: %s", e)
            raise
    ...
    def get_queue_stats(self) -> Dict[str, Any]:
        ...
        try:
            with get_repository_context() as repo:
                ...
                retry_eligible_count = repo.session.query(Message).filter(
            ...
            self._logger.error("Failed to get queue stats: %s", e)
            raise
