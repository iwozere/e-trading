...
class NotificationAnalytics:
    ...
    async def get_delivery_rates(
        ...
        try:
            ...
            self._logger.error("Failed to get delivery rates: %s", e)
            raise
    ...
    async def get_response_time_analysis(
        ...
        try:
            ...
            self._logger.error("Failed to get response time analysis: %s", e)
            raise
    ...
    async def get_aggregated_statistics(
        ...
        try:
            ...
            self._logger.error("Failed to get aggregated statistics: %s", e)
            raise
    ...
    async def get_trend_analysis(
        ...
        try:
            ...
            self._logger.error("Failed to perform trend analysis: %s", e)
            raise
    ...
    async def get_channel_performance_comparison(
        ...
        try:
            ...
            self._logger.error("Failed to get channel performance comparison: %s", e)
            raise
    ...
    def _get_message_statistics(
        ...
        try:
            ...
            self._logger.error("Failed to get message statistics: %s", e)
    ...
    def _calculate_channel_rates(
        ...
        try:
            ...
            self._logger.error("Failed to calculate channel rates: %s", e)
            return {}
    ...
    def _calculate_user_rates(
        ...
        try:
            ...
            self._logger.error("Failed to calculate user rates: %s", e)
            return {
                "user_id": user_id,
                "total_messages": 0,
    ...
    def _get_response_time_data(
        ...
        try:
            ...
            self._logger.error("Failed to get response time data: %s", e)
            return []
    ...
    def _get_time_series_data(
        ...
        try:
            ...
            self._logger.error("Failed to get time series data: %s", e)
            return []
    ...
    def _get_active_channels(self, repo, cutoff_date: datetime) -> List[str]:
        ...
        try:
            ...
            self._logger.error("Failed to get active channels: %s", e)
            return []
