...
class TestHMMLSTMBacktest(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.test_config = {
            ...
            "strategy": {"name": "HMMLSTMStrategy", "entry_threshold": 0.6, "regime_confidence_threshold": 0.7},
            "data": {"data_dir": "data", "start_date": "2023-01-01", "end_date": "2024-01-01"},
            "risk_management": {
            ...
            "optimization": {
                "enabled": False,
                "n_trials": 50,
                "optimize_params": ["entry_threshold", "exit_threshold", "regime_confidence_threshold"],
                "parameter_ranges": {
                    "entry_threshold": {"min": 0.3, "max": 0.8, "type": "float"},
                    "exit_threshold": {"min": 0.2, "max": 0.7, "type": "float"},
                    "regime_confidence_threshold": {"min": 0.5, "max": 0.9, "type": "float"},
                },
            },
        }
    ...
    def test_results_serialization(self):
        ...
        test_results = {
            ...
            "trades": {"total": np.int64(50), "won": np.int32(30)},
        }
