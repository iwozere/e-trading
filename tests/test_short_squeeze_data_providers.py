    ...
    def test_get_short_squeeze_batch_data_success(self, mock_get):
        ...
        def mock_response_side_effect(url, **kwargs):
            ...
            if "profile" in url:
                ...
                mock_response.json.return_value = [
                    {"symbol": "AAPL", "shortInterest": 50000000, "shortInterestRatio": 3.33}
                ]
            elif "key-metrics" in url:
                mock_response.json.return_value = [
                    {"symbol": "AAPL", "marketCapitalization": 3000000000000, "peRatio": 25.5}
                ]
            else:
                mock_response.json.return_value = {}
...
class TestFinnhubShortSqueezeExtensions(unittest.TestCase):
    ...
    def test_get_sentiment_data_success(self, mock_get):
        ...
        mock_response.json.return_value = {
            ...
            "buzz": {"articlesInLastWeek": 150, "weeklyAverage": 100},
    ...
    def test_get_borrow_rates_data_success(self, mock_get):
        ...
        mock_response = Mock()
        mock_response.status_code = 200
        mock_response.json.return_value = {"fee": 0.05, "available": 1000000, "feeRate": 5.0}
        mock_get.return_value = mock_response
    ...
    def test_calculate_call_put_ratio_success(self):
        ...
        # Test data
        options_data = {"symbol": "AAPL", "total_call_volume": 1800, "total_put_volume": 800}
    ...
    def test_calculate_call_put_ratio_zero_puts(self):
        ...
        # Test data
        options_data = {"symbol": "AAPL", "total_call_volume": 1800, "total_put_volume": 0}
...
class TestDataProviderIntegration(unittest.TestCase):
    ...
    def test_error_resilience(self):
        ...
        with (
            patch("src.data.downloader.fmp_data_downloader.requests.get") as mock_fmp_get,
...
def run_tests():
    ...
    # Add test cases
    test_classes = [TestFMPShortSqueezeExtensions, TestFinnhubShortSqueezeExtensions, TestDataProviderIntegration]
